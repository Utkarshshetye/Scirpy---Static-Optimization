    ...
    public boolean canMerge() {
        ...
        if (getSuccRegions().size() > 1) {
            if (getSuccRegions().size() == 2) {
                ...
                //Bhushan Start: both successor have same and single successor and both successor have single predecessor
                else{
...
//			return false;
    ...
    public ARegion merge() {
        ...
        //Bhushan Modification for corner case of if condition
