    ...
    public IExpr getArg() {
        ...
        switch (argsType) {
            ...
            case "Subscript":
                ...
                /*
                 * IExpr attribute=parseAttribute(argsAttributeValueObj);Starred still Not
                 * implemented in Arguements for a function at line:4
                 * 
                 * 
                 */
            ...
            case "Attribute":
                ...
                // call.getArgs().add(attribute)
                break;
            // TODO check this arg..this is not name, but it should be mapped to the place
            ...
            case "Dict":
                ...
                break;
            case "Starred":
                // Handle Starred expression: *args. Wrap in Starred Expr.
                JSONObject starredValue = (JSONObject) argsObj.get("value");
                ArgParser starredParser = new ArgParser(starredValue);
                arg = new Starred(starredParser.getArg());
                break;
            default:
                System.out.println(argsType + " still Not implemented in Arguements for a function at line:" + lineno);
                exit(1);
