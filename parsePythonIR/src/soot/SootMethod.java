...
/**
 * File: SootMethod.java
 *
 * History:
 * November, 2013 [Venkatesh EK] : created (same as SootMethod from soot
 * package but this implements Serializable)
 */
...
/**
 * Same as soot.SootMethod except that it implements Serializable
 */
public class SootMethod
        extends AbstractHost
        implements ClassMember, Numberable, MethodOrMethodContext, Serializable {
...
//        if(name.equals("main")){
//            this.parameterTypes="java.util.String[]";
//        }
    ...
    private static String getSubSignatureImpl(
        ...
        //Bhushan--a little hack to let soot identify main method
//        if(Scene.v().quotedNameOf(name).equals("main")){
