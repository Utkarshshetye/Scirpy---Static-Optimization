...
filename='campus21.log.20150603-20150614.log.gz.csv'
# filename='campus21.log.20150427-20150602.log.gz.csv.csv'
chunksize= 1000
tp= pd.read_csv('./Data/New data/{}'.format(filename),header=None,sep=";", chunksize= chunksize, iterator=True)
...
df.iloc[:,1].plot(figsize=(20,6),colormap='Accent')
