...
start = time.time()
SO_columns = ["Start_Time","Severity","Distance(mi)","State"]
SO_d_d_t = ["Start_Time"]
SO_c_d_t = {"Severity":"int64","Start_Time":"str","Distance(mi)":"float32","State":"category"}
df = pd.read_csv("/home/bhushan/Downloads/US_Accidents_Dec20.csv",usecols=SO_columns,parse_dates=SO_d_d_t,dtype=SO_c_d_t)
